 ...
 */
case class VickeryAuction(bidTime: FiniteDuration, deleteTime: FiniteDuration, system: ActorSystem, auctionSearchName: String) extends Agent with FSM[AuctionState, AuctionData]{
