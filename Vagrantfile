...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.define "slave-1" do |slave1|
    ...
    slave1.vm.network "private_network", ip: "10.0.1.188"
    slave1.vm.provision "ansible" do |ansible|
        ansible.playbook = "slaves-vagrant.yml"
    end
  end

  config.vm.define "slave-2" do |slave2|
    slave2.vm.box = "ubuntu/trusty64"
    slave2.vm.network "private_network", ip: "10.0.1.221"
  ...
  # using a specific IP.
  # config.vm.network "private_network", ip: "10.0.0.240"
